...
let sphere1 = mkSphere (mkPoint 0.5 0.0 0.0) 2.0 (mkMaterial (Colour.fromColor Color.Blue) 0.0)
let sphere2 = mkSphere (mkPoint -0.5 0.0 0.0) 2.0 (mkMaterial (Colour.fromColor Color.Blue) 0.0)

let sphere3 = mkSphere (mkPoint 2.5 0.0 0.0) 2.0 (mkMaterial (Colour.fromColor Color.Blue) 0.0)
let sphere4 = mkSphere (mkPoint -2.5 0.0 0.0) 2.0 (mkMaterial (Colour.fromColor Color.Blue) 0.0)
