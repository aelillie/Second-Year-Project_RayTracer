...
open System.Drawing
  ...
  (* Input the path (local or absolute) where you want your files to be stored *)
      ...
      let renderSphere toScreen =
        ...
        let camera = mkCamera (mkPoint 0.0 4.0 4.0) (mkPoint 0.0 0.0 0.0) (mkVector 0.0 1.0 0.0) 1.0 2.0 2.0 500 500
        ...
        let scene = Scene.mkScene [plane;sphere;sphere1;sphere2;sphere3;sphere4;sphere5] [light;light2] ambientLight camera 2
