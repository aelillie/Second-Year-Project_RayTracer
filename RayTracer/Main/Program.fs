...
let main argv =
    ...
    let render toScreen =
        ...
        let implicitPlane = mkShape (mkImplicit  "x^3+-x+-1") (mkMaterial (fromColor Color.Blue) 0.4) in //(x + -2)^2(x+2)^2 + (y + -2)^2(y+2)^2 + (z + -2)^2(z+2)^2 + 3(x^2*y^2 + x^2z^2 + y^2z^2) + 6x y z + -10(x^2 + y^2 + z^2) + 22
