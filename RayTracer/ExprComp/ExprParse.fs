...
// 
//let rec insertMult = function
//  Float r :: Var x :: ts -> insertMult(Float r::Mul::Var x::ts) // This approach is naïve and might be quite slow for large functions with a lot of implicit multiplications.
